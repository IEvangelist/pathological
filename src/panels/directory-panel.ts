...
export class DirectoryPanel {
  ...
  public updateStats(stats: PathologicalStats) {
    // Send a message to the webview webview.
    // You can send any JSON serializable data.
    this._panel.webview.postMessage(stats);
  }
  ...
  private _getHtmlForWebview(webview: vscode.Webview, statTypeIcon: string, stats: PathologicalStats) {
    ...
    const name = path.basename(stats.sourceUri.fsPath);
      ...
      webview.cspSource
			...
			<body>
                ...
                <div class="pb-1">
                    ...
                    <p><span class="term">Unique File Types</span> <span class="value">${
                      stats.uniqueFileTypeCount
                    }</span></p>
                </div>
                <h2>File Tree</h2>
